...
first_letter = [word[0] for word in listOfWords]
print(first_letter)
...
get_digit = [x for x in string if x.isdigit()]
print(get_digit)
get_letters = [x for x in string if x.isalpha()]
print(get_letters)
...
# expression, iteration, and evaluation / condition are the 3 parts to list comphrension
# first goes to iteration, then condition and lastly expression